# 🗄️ webar-demo — tasks.md as it stood before the R-063 shape (2026-07-29)

> Verbatim copy, kept because headings and completed items carry decision records the roadmap itself must not.
> The live list is `../tasks.md`.
